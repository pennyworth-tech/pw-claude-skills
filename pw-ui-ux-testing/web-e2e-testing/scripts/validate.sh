#!/bin/bash
# Web E2E Testing Skill Validator v1.0.0
set -euo pipefail
...
SKILL_NAME="web-e2e-testing"
SKILL_VERSION="1.0.0"
SCHEMA_PATH="$SKILL_DIR/schemas/output.schema.json"
MUST_CONTAIN_TERMS=("e2e" "browser")
...
[[ "$skill_name" != "web-e2e-testing" ]] && { error "Invalid skillName"; exit 1; }

# Check testResults and browserCoverage
